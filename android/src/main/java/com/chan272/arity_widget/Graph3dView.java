...
public class Graph3dView extends GLView implements
    ...
    public void onTouchUp(float x, float y) {
        ...
        // CalculatorView.log("velocity " + vx + ' ' + vy);
    ...
    public void onSurfaceCreated(GL10 gl, int width, int height) {
        ...
        gl.glShadeModel(CalculatorView.useSmoothShading3D ? GL10.GL_SMOOTH : GL10.GL_FLAT);
    ...
    public void onDrawFrame(GL10 gl10) {
        ...
        if (fps.incFrame()) {
            CalculatorView.log("f/s " + fps.getValue());
        }
    ...
    private void printMatrix(float[] m, String name) {
        ...
        CalculatorView.log(name + ' ' + b.toString());
    }
}
