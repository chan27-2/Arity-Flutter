...
public class ShowGraph extends AppCompatActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        ArrayList<Function> funcs = CalculatorView.graphedFunction;
        if (funcs == null) {
            finish();
            return;
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            // builder.setView(lay);
            //
            // builder.setPositiveButton(getString(android.R.string.ok), (dialog,
            // whichButton) -> {
            // float cx = 0;
            // float cy = 0;
            // if (!centerX.getText().toString().equals("")) cx =
            // Float.parseFloat(centerX.getText().toString());
            // if (!centerY.getText().toString().equals("")) cy =
            // Float.parseFloat(centerY.getText().toString());
            ...
            // });
            //
            // builder.setNegativeButton(getString(android.R.string.cancel), (dialog,
            // whichButton) -> dialog.cancel());
            // builder.show();
            // break;
            // default:
            // return false;
