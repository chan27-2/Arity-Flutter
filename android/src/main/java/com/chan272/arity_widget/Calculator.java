...
//
// public class Calculator extends View implements TextWatcher,
// View.OnKeyListener, View.OnClickListener,
// SharedPreferences.OnSharedPreferenceChangeListener
// {
// static final char MINUS = '\u2212', TIMES = '\u00d7', DIV = '\u00f7', SQRT =
//// '\u221a', PI = '\u03c0',
...
// // final boolean hasKeyboard = config.hardKeyboardHidden ==
...
// input.setInputType(InputType.TYPE_TEXT_FLAG_NO_SUGGESTIONS); //With InputType
//// 0 the cursor vanishes
// input.setTextIsSelectable(true);
// getWindow().setFlags(WindowManager.LayoutParams.FLAG_ALT_FOCUSABLE_IM,WindowManager.LayoutParams.FLAG_ALT_FOCUSABLE_IM);
//// //make sure, soft-keyboard is not opened (if window is focusable, setting
//// this flag prevents this window from becoming the target of the input
//// method)
...
// }
// getWindow().setStatusBarColor(arity.calculator.Util.getThemeColor(this,
...
//// GithubStar.starDialog(this,"https://github.com/woheller69/Arity");
// }
//
// public void onPause() {
// super.onPause();
...
//// Uri.parse("https://github.com/woheller69/Arity")));
// break;
//
// default:
// return false;
...
//
// void evaluate() {
// System.out.println("evaluate " + input.getText().toString());
...
// int width = result.getWidth() - result.getTotalPaddingLeft() -
//// result.getTotalPaddingRight();
